...
class local_directory_search{
    ...
    public function search(local_directory_search_options $searchoptions) {
        ...
        list($customselect, $customfrom, $customwhere) = $this->getcustomparts($searchoptions);
    ...
    /**
     * some sql parts generated by custom fields requirement
     * @param local_directory_search_options $options
     * @return array
     */
    ...
    public function searchcondition(local_directory_search_options $searchoptions) {
        ...
        foreach ($terms as $idx => $term) {
            $orfields = array();
            foreach ($searchoptions->fieldssearch as $field) {
                $paramidx++;
                $orfields[] = $DB->sql_like($field, ":q$paramidx", false, false);
                $params["q$paramidx"] = "%".addcslashes($term, '%_')."%";
            }
            $terms [$idx] = '('.implode(' OR ', $orfields).') ';
        }
        ...
        $requiredcondition = "";
        foreach ($searchoptions->fields_required as $requiredfield) {
